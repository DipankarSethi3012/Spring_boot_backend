...
public class SellerReport {
    ...
    public SellerReport(Long id, Seller seller, Long totalEarnings, Long totalSales, Long totalRefunds, Long totalTax, Long netEarnings, Integer totalOrders, Integer canceledOrders, Integer totalTransactions) {
        this.id = id;
        this.seller = seller;
